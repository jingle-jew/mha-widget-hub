...
const controls = [
  ...
  control({ id: "ios.glass.grain", token: "--mha-glass-noise-opacity", label: "Grain opacity", description: "Opacité du grain optique iOS.", category: "grain", control: "range", min: 0, max: 1, step: 0.001, unit: "", themes: ["ios"], file: "styles/themes/ios-raw-materials.css", selector: ':host([data-theme-style="ios"])' }),
  control({ id: "ios.glass.blend", token: "--mha-glass-noise-blend-mode", label: "Grain blend mode", description: "Mode de fusion du grain iOS.", category: "grain", control: "select", options: ["soft-light", "overlay", "multiply", "screen", "normal"], themes: ["ios"], file: "styles/themes/ios-raw-materials.css", selector: ':host([data-theme-style="ios"])' }),
  control({ id: "ios.shell.blur", token: "--mha-ios-raw-liquid-shell-blur", label: "Shell blur", description: "Flou de la coque iOS Liquid Glass.", category: "blur", control: "range", min: 0, max: 40, step: 1, unit: "px", themes: ["ios"], file: "styles/themes/ios-raw-materials.css", selector: ':host([data-theme-style="ios"])' }),
  control({ id: "ios.shell.saturation", token: "--mha-ios-raw-liquid-shell-saturation", label: "Shell saturation", description: "Saturation de la coque iOS Liquid Glass.", category: "saturation", control: "range", min: 80, max: 240, step: 1, unit: "%", themes: ["ios"], file: "styles/themes/ios-raw-materials.css", selector: ':host([data-theme-style="ios"])' }),
  control({ id: "ios.reflection.opacity", token: "--mha-ios-raw-liquid-shell-highlight-opacity", label: "Reflection opacity", description: "Intensité du reflet de surface iOS.", category: "reflets", control: "range", min: 0, max: 1, step: 0.01, unit: "", themes: ["ios"], file: "styles/themes/ios-raw-materials.css", selector: ':host([data-theme-style="ios"])' }),
  control({ id: "ios.grain.opacity", token: "--mha-glass-noise-opacity", label: "Liquid grain opacity", description: "Grain du matériau Liquid Glass.", category: "grain", control: "range", min: 0, max: 1, step: 0.001, unit: "", themes: ["ios"], file: "styles/themes/ios-raw-materials.css", selector: ':host([data-theme-style="ios"])' }),
  modeColor("ios", ':host([data-theme-style="ios"][data-theme="light"])', "ios.surface.light", "--mha-ios-raw-liquid-primary-surface", "Light primary surface", "surfaces", "styles/themes/ios-raw-materials.css"),
  modeColor("ios", ':host([data-theme-style="ios"][data-theme="dark"])', "ios.surface.dark", "--mha-ios-raw-liquid-primary-surface", "Dark primary surface", "surfaces", "styles/themes/ios-raw-materials.css"),
  modeColor("ios", ':host([data-theme-style="ios"][data-theme="light"])', "ios.border.light", "--mha-ios-raw-liquid-primary-border", "Light primary border", "bordures", "styles/themes/ios-raw-materials.css"),
  modeColor("ios", ':host([data-theme-style="ios"][data-theme="dark"])', "ios.border.dark", "--mha-ios-raw-liquid-primary-border", "Dark primary border", "bordures", "styles/themes/ios-raw-materials.css"),
