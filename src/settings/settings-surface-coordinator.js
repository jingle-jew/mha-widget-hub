...
export function createSettingsSurfaceCoordinator(host) {
  ...
  function getProps() {
    ...
    return buildSettingsCoordinatorProps({
      ...
      weatherUseThemeBackground: weatherPage?.config?.useThemeBackground === true,
      hass: host._hass,
      ...
      callbacks: {
        ...
        onOpenNavigationSettings: () => host._openSettings("navigation"),
        ...
        onNowBarMainBack: () => host._openSettings("customization"),
        onOpenWeatherPageSettings: () => host._openWeatherPageSettings(),
        onWeatherPageMainBack: () => host._openSettings("customization"),
        onWeatherLandscapeChange: (value) => host._applyWeatherLandscapeFromSettings(value),
        onWeatherThemeBackgroundChange: (value) => host._applyWeatherThemeBackgroundFromSettings(value),
        onWallpaperMainBack: () => host._openSettings("customization"),
        ...
        onDockMainBack: () => host._openSettings("navigation"),
